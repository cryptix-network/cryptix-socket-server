...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  DESCRIPTOR._serialized_options = b'Z-github.com/cryptix-network/cryptixd/infrastructure/network/netadapter/server/grpcserver/protowire'
